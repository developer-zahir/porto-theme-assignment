            ...
            this.POLL_INTERVAL
              ...
              : (h(o, "resize", n, !0),
                ...
                this.USE_MUTATION_OBSERVER &&
                  ...
                  (s = new o.MutationObserver(n)).observe(e, { attributes: !0, childList: !0, characterData: !0, subtree: !0 })),
...
(function ($) {
  ...
  try {
    if (window.location !== window.parent.location) {
      $(window).on("load", function () {
        $el = $("<a />").addClass("remove-envato-frame").attr({ href: window.location.href, target: "_parent" }).text("Remove Frame");
        $("body").append($el);
      });
    }
  } catch (e) {
...
(function (factory) {
  ...
  CountTo.DEFAULTS = { from: 0, to: 0, speed: 1000, refreshInterval: 100, decimals: 0, formatter: formatter, onUpdate: null, onComplete: null };
    ...
    var onScroll = function () {
      ...
      for (var i = 0, len = elements.length; i < len; i++) {
        ...
        if (from < scrollY && to > scrollY) {
          !($this.css("position") == "fixed") && $this.css({ left: $this.offset().left, top: data.pad.top }).css("position", "fixed");
          if (options.activeClass) {
    ...
    if ($word.parents(".word-rotator").hasClass("type")) {
      ...
      if (document.hasFocus()) {
        $word
          .parents(".word-rotator-words")
          .stop(true, true)
          .animate({ width: $word.outerWidth() + 10 }, revealDuration, function () {
            setTimeout(function () {
              hideWord($word);
...
(function ($) {
  $.fn.hover3d = function (options) {
    ...
    return this.each(function () {
      ...
      $shine.css({ position: "absolute", top: 0, left: 0, bottom: 0, right: 0, transform: "translateZ(1px)", "z-index": 9 });
      ...
      function move(event) {
        ...
        $card.css({ perspective: settings.perspective + "px", transformStyle: "preserve-3d", transform: "rotateY(" + ax + "deg) rotateX(" + ay + "deg)" });
        $shine.css("background", "linear-gradient(" + angle + "deg, rgba(255,255,255," + (event.offsetY / h) * 0.5 + ") 0%,rgba(255,255,255,0) 80%)");
      }
      function leave() {
        $card.addClass(settings.hoverOutClass + " " + settings.hoverClass);
        $card.css({ perspective: settings.perspective + "px", transformStyle: "preserve-3d", transform: "rotateX(0) rotateY(0)" });
        setTimeout(function () {
...
(function (theme, $) {
  ...
  PluginAnimate.defaults = { accX: 0, accY: -80, delay: 100, duration: "750ms", minWindowWidth: 0, forceAnimation: false };
  PluginAnimate.prototype = {
    ...
    animate: function () {
      ...
      if (
        (!$("html").hasClass("no-csstransitions") && $(window).width() > self.options.minWindowWidth && elTopDistance >= windowTopDistance) ||
...
(function (theme, $) {
  ...
  PluginAnimatedLetters.defaults = { animationName: "fadeIn", animationSpeed: 50, startDelay: 500, minWindowWidth: 768, letterClass: "" };
...
(function (theme, $) {
  ...
  PluginCarouselLight.prototype = {
    ...
    changeSlide: function ($nextSlide) {
      ...
      self.$el.trigger({ type: "change.owl.carousel", nextSlideIndex: $nextSlide.index(), prevSlideIndex: $prevSlide.index() });
      setTimeout(function () {
        self.$el.trigger({ type: "changed.owl.carousel", nextSlideIndex: $nextSlide.index(), prevSlideIndex: $prevSlide.index() });
      }, 500);
    },
    owlNav: function () {
      var self = this,
    ...
    navigationOffsets: function () {
      ...
      if (self.options.navVerticalOffset && self.options.navHorizontalOffset) {
        if (!navHasTransform) {
          ...
          $el.find(".owl-nav").css({ top: "calc( 50% - " + self.options.navVerticalOffset + " )", left: self.options.navHorizontalOffset });
        }
      }
    ...
    events: function () {
      ...
      $("[data-cursor-effect-hover]").on("mouseenter", function (e) {
        ...
        switch ($(this).data("cursor-effect-hover")) {
          case "fit":
            ...
            $cursorOuter.css({ width: thisBox.width, height: thisBox.height, "border-radius": $(this).css("border-radius") }).addClass("cursor-outer-fit");
      ...
      $("[data-cursor-effect-hover]").on("mouseleave", function () {
        ...
        switch ($(this).data("cursor-effect-hover")) {
          case "fit":
            $cursorOuter
              .css({ width: initialCursorOuterBox.width, height: initialCursorOuterBox.height, "border-radius": initialCursorOuterRadius })
...
(function (theme, $) {
  ...
  PluginIcon.defaults = { color: "#2388ED", animated: false, delay: 300, onlySVG: false };
    ...
    build: function () {
      ...
      if (self.options.scrollableParallax && $(window).width() > self.options.scrollableParallaxMinWidth) {
        ...
        if ($scrollableWrapper.get(0)) {
          var progress =
              $(window).scrollTop() > self.options.wrapper.offset().top + $(window).outerHeight() ? self.options.cssValueEnd : self.options.cssValueStart,
  ...
  PluginReadMore.prototype = {
    ...
    build: function () {
      ...
      self.options.wrapper
        ...
        .css({ background: backgroundCssValue, position: "absolute", bottom: 0, left: 0, width: "100%", height: self.options.overlayHeight, "z-index": 1 });
      self.options.wrapper
...
(function (theme, $) {
  ...
  PluginRevolutionSlider.defaults = {
    ...
    addOnCountdown: { enable: false, targetdate: new Date().getTime() + 864000000, slidechanges: [{ days: 0, hours: 0, minutes: 0, seconds: 0, slide: 2 }] },
        ...
        $(window).on("scroll", function () {
          ...
          $(".section-scroll").each(function () {
            if ($(this).offset().top <= $(window).scrollTop() + 50) {
              ...
              $(window).trigger({ type: "section.scroll.mobile.change.header.color", currentSection: $currentSection2 });
            }
            index++;
          });
        });
    ...
    dotsNavigation: function () {
      ...
      for (var i = 0; i < $(".section-scroll").length; i++) {
        ...
        dotsNav
          .find("> ul")
          .append(
            "<li" + (currentSectionIndex == i ? ' class="active"' : "") + '><a href="#' + i + '" data-nav-id="' + i + '"><span>' + title + "</span></a></li>"
          );
      }
      $(".body").append(dotsNav);
...
(function (theme, $) {
  ...
  PluginTweets.prototype = {
    ...
    build: function () {
      ...
      $.ajax({
        type: "GET",
        data: { twitter_screen_name: self.options.username, tweets_to_display: self.options.count, icon_color: self.options.iconColor },
...
(function (theme, $) {
  ...
  PluginVideoBackground.prototype = {
    ...
    setOptions: function (opts) {
      this.options = $.extend(true, {}, PluginVideoBackground.defaults, opts, { path: this.$el.data("video-path"), wrapper: this.$el });
      return this;
    },
    build: function () {
      var self = this;
            ...
            init: function () {
              ...
              $(window).scroll(function () {
                ...
                self.$menuFloating
                  ...
                  .css({ transform: "translateY( calc(" + scrollPercent + "vh - " + st / divisor + "px) )" });
              });
            },
          };
        ...
        $header
          ...
          .on("click", function (e) {
            ...
            if ($window.width() < 992) {
              ...
              var height =
                $header.hasClass("header-effect-shrink") && $html.hasClass("sticky-header-active")
    ...
    StickyHeader: {
      ...
      build: function () {
        ...
        self.activateStickyHeader = function () {
          ...
          if (self.options.stickyEffect == "shrink") {
            if (self.options.wrapper.find(".header-top").get(0)) {
              self.options.wrapper.find(".header-top").css({ height: 0, "min-height": 0, overflow: "hidden" });
            }
            if (self.options.stickyHeaderContainerHeight) {
              self.options.wrapper.find(".header-container").css({ height: self.options.stickyHeaderContainerHeight, "min-height": 0 });
            } else {
              self.options.wrapper.find(".header-container").css({ height: (initialHeaderContainerHeight / 3) * 2, "min-height": 0 });
              var y = initialHeaderContainerHeight - (initialHeaderContainerHeight / 3) * 2;
              $(".main")
                .css({ transform: "translate3d(0, -" + y + "px, 0)", transition: "ease transform 300ms" })
        ...
        self.deactivateStickyHeader = function () {
          ...
          if (self.options.stickyEffect == "shrink") {
            ...
            if (self.options.wrapper.find(".header-top").get(0)) {
              self.options.wrapper.find(".header-top").css({ height: initialHeaderTopHeight, overflow: "visible" });
